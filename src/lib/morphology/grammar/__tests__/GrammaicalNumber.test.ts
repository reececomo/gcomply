import { GrammaticalNumber } from "../GrammaticalNumber";

describe("GrammaticalNumber", () =>
{
    describe("Codable behaviors", () =>
    {
        const cases: [GrammaticalNumber, string][] = [
            [GrammaticalNumber.singular,    "one"],
            [GrammaticalNumber.zero,        "zero"],
            [GrammaticalNumber.plural,      "other"],
            [GrammaticalNumber.pluralTwo,   "two"],
            [GrammaticalNumber.pluralFew,   "few"],
            [GrammaticalNumber.pluralMany,  "many"],
        ];

        const Codable = GrammaticalNumber;
